 ...
 * BookmarkIcon 컴포넌트
 *
 * 이 컴포넌트는 북마크 아이콘을 렌더링합니다.
 * SVG 요소를 사용하여 아이콘을 정의하고, 전달된 props를 통해 스타일이나 기타 속성을 적용할 수 있습니다.
 *
 * @param {Object} props - 이 컴포넌트에 전달된 props.
 * @returns {JSX.Element} SVG 북마크 아이콘 요소.
 */
